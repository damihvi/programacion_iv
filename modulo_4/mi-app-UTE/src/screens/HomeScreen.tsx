  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.body}>Navegación con Stack + TypeScript</Text>
          ...
          <Pressable
              style={[styles.btn, { marginTop: 10 }]}
              onPress={() => navigation.navigate("TrapezoidArea")}
          >
          ...
          <Pressable
              style={[styles.btn, { marginTop: 10 }]}
              onPress={() => navigation.navigate("NewtonForce")}
          >
              <Text style={styles.btnText}>ejercicio de newton</Text>
          </Pressable>
          ...
          >
            <Text style={styles.btnText}>Ir a Productos</Text>
          </Pressable>

          <Pressable
            style={[styles.btn, { marginTop: 10 }]}
            onPress={() => navigation.navigate("Profile", { userId: "u1", name: "Francisco", lastName: "García" })}
          >
