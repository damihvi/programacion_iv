...
class Calculoviaje extends StatefulWidget {
  const Calculoviaje({super.key});

  @override
  State<Calculoviaje> createState() => _CalculoviajeState();
}

class _CalculoviajeState extends State<Calculoviaje> {
  // TextFields
  String daysText = '';
  String peopleText = '';
